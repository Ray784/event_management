                            ...
                            <div class="panel-footer">
                                <div class="container">
                                    <div class="row-main">
                                        ...
                                        <?php if($blog['approval']==0){?>
                                        <div class="col-md-2 col-xs-2 col-lg-2 col-sm-2">
                                            <form method="post" action="approve.php"><button type="submit" name="approve" id="approve" onclick="return confirm('Are you sure?')" value="<?php echo $blog['image_url'];?>" class="btn btn-warning center">Approve</button></form><?php }?>
                                        </div>
                                    </div>
                                </div>
                            </div>
